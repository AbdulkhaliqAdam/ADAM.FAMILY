...
import 'package:adam_family/utils/showOtpDialog.dart';
import 'package:adam_family/utils/showSnackbar.dart';
...
class FirebaseAuthMethods extends GetxController {
  static FirebaseAuthMethods get instance => Get.find();
...
// //
  ...
  //   firebaseUser.bindSrteam(_auth.userChanges());
